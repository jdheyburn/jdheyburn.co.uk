...
{{< figure src="namecheap_landing.png" link="namecheap_landing.png" caption="The hardest part is deciding on the domain name..." alt="Screenshot depicting the namecheap domain landing page" >}}

{{< figure src="namecheap-domain-purchase.png" link="namecheap-domain-purchase.png" alt="Screenshot depicting the namecheap domain purchase page" >}}
...
{{< figure src="namecheap-domain-acquired.png" link="namecheap-domain-acquired.png" caption="Make sure you have auto-renew selected, otherwise you can kiss that domain goodbye when it expires!" alt="Screenshot depicting the namecheap domain landing page" >}}
...
{{< figure src="cloudflare-add-domain.png" link="cloudflare-add-domain.png" caption="Enter your newly purchased domain from the previous section" alt="Screenshot depicting the Cloudflare add domain page" >}}
...
{{< figure src="cloudflare-domain-landing.png" link="cloudflare-domain-landing.png" caption="Name me a more iconic duo than numbers and graphs. I'll wait..." alt="Screenshot depicting the Cloudflare domain home page" >}}
...
{{< figure src="cloudflare-dns-record.png" link="cloudflare-dns-record.png" caption="Add in the GitHub IP addresses one by one" alt="Screenshot depicting adding DNS records to Cloudflare" >}}

Once done - your records will look something like this:

{{< figure src="cloudflare-completed-records.png" link="cloudflare-completed-records.png" caption="" alt="Screenshot depicting completed DNS management" >}}
...
{{< figure src="cloudflare-nameservers.png" link="cloudflare-nameservers.png" caption="Make a note of these nameservers for your domain" alt="Screenshot depicting completed Cloudflare DNS nameservers" >}}
...
{{< figure src="namecheap-nameservers.png" link="namecheap-nameservers.png" class="center" caption="Add in your Cloudflare domains from previously" alt="Screenshot depicting completed nameservers pointing to Cloudflare" >}}
...
{{< figure src="github_pages_setup.png" link="github_pages_setup.png" caption="Ignore my already published domain..." alt="Screenshot depicting GitHub Pages form for specifying a custom domain" >}}
...
{{< figure src="jdheyburn_co_uk_custom_domain.png" link="jdheyburn_co_uk_custom_domain.png" caption="You should end up with something like this!" alt="Screenshot depicting completed custom domain" >}}
...
{{< figure src="cloudflare_page_rules.png" link="cloudflare_page_rules.png" alt="Screenshot depicting how to access the Create Page Rule feature" >}}
...
{{< figure src="cloudflare_new_page_rule.png" link="cloudflare_new_page_rule.png" alt="Screenshot depicting how to populate the Create Page Rule form" >}}
...
{{< figure src="cloudflare_completed_page_rule.png" link="cloudflare_completed_page_rule.png" alt="Screenshot depicting the newly created page rule" >}}
