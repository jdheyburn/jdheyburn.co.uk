...
The blog platform itself is pretty basic. It is built using [Hugo](https://gohugo.io/) and hosted using [GitHub Pages](https://pages.github.com/). While this isn't exactly anything to brag about, it is only meant to be a quick and easy platform to spin up and get hosted so that I can focus on what really matters... the content!
